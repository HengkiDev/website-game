function shuffle(array) {
  ...
  function updateMoveCounter() {
    movesCounter++;
    moves.textContent = "Menggerakan: " + movesCounter;
    if (movesCounter === 13) {
  ...
  function timer() {
    ...
    if (s % 60 < 10) {
        timer.textContent = "Waktu: " + m + ":0" + s % 60;
    } else {
        timer.textContent = "Waktu: " + m + ":" + s % 60;
    }
  ...
  function restartGame() {
    ...
    let timer = document.querySelector(".timer");
    timer.textContent = "Waktu: 0:00";
    moves.textContent = "Waktu: " + movesCounter;
